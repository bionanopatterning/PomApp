...
with st.expander("Stage 2 details"):
    ...
    st.code("pom single initialize   # parse training data for all phase2 features")
    st.code("pom single train -o Cytoplasm -gpus 0,1,2,3,4,5,6,7   # train one of the models")
    st.code("pom single test -o Cytoplasm -gpus 0,1,2,3,4,5,6,7   # optionally, test models on a selected set of tomograms")
...
with st.expander("Stage 3 details"):
    ...
    st.code("pom shared initialize   # parse & segment all training data for all phase2 features")
...
with st.expander("Summary details"):
    ...
    st.code("pom projections   # output xy and xz projection images of all organelle segmentations")

    st.code("pom render -s render_configuration.json   # batch-output 3D rendered images showing organelles and/or macromolecules as defined in render_configuration.json")
